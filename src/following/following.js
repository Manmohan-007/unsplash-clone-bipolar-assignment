...
export class FollowingCollection extends Component { 
...
componentDidMount=()=>{
      ...
      axios.get(`https://api.unsplash.com/collections/139396/photos?client_id=${this.AccessKey}`,
      { params: {   per_page : this.state.count} } 
      )
       .then(response =>{
          console.log(response.data , "original")  ;  
          this.setState({ImgData2 : [...response.data]})
         console.log(this.state.ImgData2) ; 
        ...
        { params: {  page : this.state.page ,  per_page : 30  } } 
         ...
         .then(response =>{
           ...
           this.setState({ImgData2 : updated})
            ...
            console.log(this.state.ImgData2 , "fetch data") ;
